(function init() {
  ...
  socket.on("newGame", (data) => {
    const message = `Hello, ${data.name}. You can invite your opponent to play this game using this room: ${data.room}`;
  ...
  socket.on("player1", (data) => {
    const message = `X: ${player.getPlayerName()}`;
    $("#userHello").html(message);
